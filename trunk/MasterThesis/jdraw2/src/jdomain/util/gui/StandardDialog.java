...
public class StandardDialog extends JDialog implements KeyEventDispatcher,
   ...
   private final JPanel leftButtons = new JPanel( new FlowLayout(
         FlowLayout.LEFT, 0, 0 ) );
   public final AntialiasPanel main = new AntialiasPanel( new BorderLayout( 0,
         0 ) );
   private int result = CANCEL_ACTION;
      ...
      addWindowListener( new WindowAdapter() {
         ...
         public final void windowClosed( WindowEvent e ) {
            FocusManager.getCurrentKeyboardFocusManager()
                  .removeKeyEventDispatcher( StandardDialog.this );
         }
         ...
         public final void windowOpened( WindowEvent e ) {
            ...
            FocusManager.getCurrentKeyboardFocusManager()
                  .addKeyEventDispatcher( StandardDialog.this );
         }
      } );
   }
