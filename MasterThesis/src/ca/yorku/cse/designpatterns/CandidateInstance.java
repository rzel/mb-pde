...
public class CandidateInstance {
    ...
    /**
     * Datastructure that contains a <code>LinkedList</code> of nodes
     * that stores all nodes that match the dynamic definition of the 
     * design pattern.
     */
    private LinkedList[] matchedFactsDatastructure;
   
    // Is set to true if the candidate instance maches the definitions 100%
    ...
    /**
     * Set datastructure for this candidate instance with all Nodes from the dynamic  facts that match the design pattern definition.
     * @param linkedList  LinkedList datastructure of Nodes that contains all nodes that match the   dynamic linkedList design pattern definition
     */ 
